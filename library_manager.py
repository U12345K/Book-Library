import streamlit as st
 ...
 # Footer
 st.markdown("---")
 st.markdown("© 2025 Umar Khan Personal Library Manager", unsafe_allow_html=True)
 st.markdown("© 2025 Umar Khan Personal Library Manager | Created with Love and Streamlit", unsafe_allow_html=True)
